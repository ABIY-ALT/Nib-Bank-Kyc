...
async function main() {
  ...
  const rolePermissions: Record<string, string[]> = {
    ...
    DISTRICT_DIRECTOR: ['DASHBOARD_VIEW', 'DASHBOARD_VIEW_DISTRICT', 'REPORT_VIEW_DISTRICT', 'CASE_VIEW_BRANCH', 'VIEW_FQ_LIBRARY', 'VIEW_GOVERNANCE_QUEUE', 'TRIGGER_GOVERNANCE_FLOW'],
  };
