...
export default function OfficerReportsPage() {
  ...
  const handleGenerateReport = () => {
    ...
    toast({
      ...
      description: `Analyzed ${submissions.length} historical verification actions.`,
    });
  };
  ...
  const handleExport = () => {
    toast({
      ...
      description: "Compiling staff efficiency dataset...",
    });
  };
    ...
    <div className="space-y-8 animate-in fade-in duration-300">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex gap-2">
          ...
          <Button className="gap-2 bg-primary shadow-lg" onClick={handleGenerateReport} disabled={loading}>
        ...
        <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-300">
          ...
          <Card className="shadow-xl border-slate-200 overflow-hidden">
            ...
            <CardContent className="p-0">
              {reportData.length === 0 ? (
                <div className="py-20 text-center italic text-muted-foreground">No historical review data found.</div>
              ) : (
                <Table>
