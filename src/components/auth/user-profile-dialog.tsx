...
export function UserProfileDialog({ children }: { children: React.ReactNode }) {
  ...
  return (
    <Dialog open={open} onOpenChange={(val) => {
      ...
      <DialogContent className="max-w-md p-0 overflow-hidden border-none shadow-2xl rounded-3xl bg-card max-h-[90vh]">
              ...
              <div className="space-y-2.5">
                ...
                <div className="relative">
                  ...
                  <Input 
                    ...
                    required
                  />
                  <button type="button" onClick={() => togglePasswordVisibility('current')} className="absolute right-4 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground">
              ...
              <div className="space-y-2.5">
                ...
                <div className="relative">
                  ...
                  <Input 
                    ...
                    required
                  />
                  <button type="button" onClick={() => togglePasswordVisibility('next')} className="absolute right-4 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground">
              ...
              <div className="space-y-2.5">
                ...
                <div className="relative">
                  ...
                  <Input 
                    ...
                    required
                  />
                  <button type="button" onClick={() => togglePasswordVisibility('confirm')} className="absolute right-4 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground">
