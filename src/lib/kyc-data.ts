...
export const EXCEPTIONAL_STATUS = {
  ...
  AWAITING_KYC_OFFICER: 'AWAITING_KYC_OFFICER',
  COMPLETED: 'COMPLETED',
  REJECTED: 'REJECTED',
...
// Sentinel used by AMENDMENT_REQUESTED stage to resolve the return stage from history.
export const EXCEPTIONAL_RESTORE_SENTINEL = '__RESTORE_PRE_AMENDMENT__';
